...
public abstract class AppDotNetBaseResponseEnvelopeHandler<T extends IAppDotNetObject> extends AppDotNetResponseHandler<T> {
    protected ResponseMeta responseMeta;

    protected AppDotNetBaseResponseEnvelopeHandler(TypeToken typeToken) {
        super(typeToken);
    }
